...
async function main(dir, depth, jsonPath, devDependencies) {
    ...
    const realDir = await (0, analyze_1.getRealPath)(dir);
    console.time('Time');
    const jsonData = await (0, analyze_1.analyze)(realDir, Math.max(1, Math.min(depth, 64)), 
